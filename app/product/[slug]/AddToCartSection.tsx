...
//   // SAFELY access cart API — do not destructure from possibly undefined
//   const cart = useCart();
//   const add = cart?.add;
...
//   function handleAdd() {
//     if (!add) {
//       // defensive: cart provider missing (shouldn't happen in normal app)
...
//   // safe access to cart API — don't destructure directly from possibly undefined
//   const cart = useCart();
//   const add = cart?.add;
...
//     // ensure we pass required CartItem fields (priceCents is required by CartContext)
//     const payload = {
...
//     add(payload as any);
//     // optional: visual feedback (kept minimal per your existing design)
//   }
