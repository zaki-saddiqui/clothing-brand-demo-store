...
//               <Link href="/" className="text-md text-gray-700 hover:text-gray-500">
//                 Home
//               </Link>
//               <Link href="/shop" className="text-md text-gray-700 hover:text-gray-500">
//                 Shop
//               </Link>
//               <Link href="/about" className="text-md text-gray-700 hover:text-gray-500">
//                 About
//               </Link>
//               <Link href="/contact" className="text-md text-gray-700 hover:text-gray-500">
//                 Contact
//               </Link>
//             </div>
...
//               >
//                 {open ? (
//                   <svg className="h-6 w-6 text-gray-700" fill="none" stroke="currentColor" strokeWidth="1.7" viewBox="0 0 24 24">
...
//             <div className="bg-[rgba(255,255,255,0.05)] ring-1 ring-white/10 rounded-xl p-4 space-y-3 shadow-lg">
//               {[
//                 ["Home", "/"],
//                 ["Shop", "/shop"],
//                 ["About", "/about"],
...
//                   className="block px-3 py-2 rounded-md text-base text-gray-200 hover:bg-white/5"
//                 >
//                   {label}
//                 </Link>
//               ))}

//               {/* Mobile Cart Button w/ Badge */}
//               <Link
//                 href="/cart"
//                 onClick={() => setOpen(false)}
//                 className="flex items-center gap-3 px-3 py-2 rounded-md text-gray-200 hover:bg-white/5"
//               >
//                 <span>Cart</span>
//                 {itemCount > 0 && (
